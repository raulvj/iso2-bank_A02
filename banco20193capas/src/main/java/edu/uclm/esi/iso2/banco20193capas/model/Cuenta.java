...
/**
* La clase {@code Cuenta} representa una cuenta bancaria.
* que ha de tener al menos un {@code Cliente} que sea titular
*/
@Entity
public class Cuenta {
@Id
...
static final double PORCENTAGE = 0.01; //0.01 is a magic number!
static final double UNOPTOCINCO = 1.5;
public Cuenta() {
...
* en la base de datos
*/
public void addTitular(final Cliente cliente) throws
...
* @throws ImporteInvalidoException Si el importe es
...
* @throws ImporteInvalidoException Si el importe es less than
* or equal to 0
* @throws SaldoInsuficienteException Si el importe is bigger
* than getSaldo()
*/
public void retirar(final double importe) throws ImporteInvalidoException,
...
/**
* Retira el importe de la cuenta, incluso aunque esta no.
...
/**
* Realiza una transferencia desde esta cuenta a la cuenta que.
...
* @throws CuentaInvalidaException Si la cuenta destino
* es esta misma o no existe en la BD
* @throws ImporteInvalidoException Si el importe es less than or equal to 0
* @throws SaldoInsuficienteException Si la cuenta no
* tiene saldo suficiente para afrontar el importe y la comisión
*/
public void transferir(final Long numeroCuentaDestino, final double importe,
final String concepto) throws CuentaInvalidaException, ImporteInvalidoException,
SaldoInsuficienteException {
...
double comision = Math.max(PORCENTAGE * importe, UNOPTOCINCO);
...
* @throws ClienteNoEncontradoException Si el cliente no está en
* la base de datos
* @throws ClienteNoAutorizadoException Si el cliente no es titular
* de esta cuenta
*/
