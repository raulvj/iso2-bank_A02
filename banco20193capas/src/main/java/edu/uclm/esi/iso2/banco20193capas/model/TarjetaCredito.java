...
* @throws SaldoInsuficienteException Si el crédito disponible de
...
*/
@Override
public void sacarDinero(final int pin, final double importe) throws
...
MovimientoTarjetaCredito principal = new
MovimientoTarjetaCredito(this, importe, "Retirada de efectivo");
double comision = THREE;
MovimientoTarjetaCredito mComision = new
MovimientoTarjetaCredito(this, comision, "Comisión por retirada de efectivo");
...
* (ver {@link #confirmarCompraPorInternet(int)}) mediante el token
...
* ({@link #getCreditoDisponible()}) de la tarjeta es menor que el importe
* @throws TarjetaBloqueadaException Si la tarjeta está bloqueada
...
double gastos = ZEROPTZERO;
List<MovimientoTarjetaCredito> mm =
Manager.getMovimientoTarjetaCreditoDAO().findByTarjetaId(this.getId());
